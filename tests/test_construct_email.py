...
def test_render_email_includes_coolpaper_for_arxiv():
    paper = make_sample_paper(url="https://arxiv.org/abs/2026.12345v2", score=7.0, tldr="ok")
    html = render_email([paper])
    assert "https://papers.cool/arxiv/2026.12345" in html
